...
if redis:get(max.."getidstatus"..msg.chat_id_) == "Photo" then
    if data.photos_[0] then 
        ...
        sendPhoto(msg.chat_id_,msg.id_,data.photos_[0].sizes_[1].photo_.persistent_id_,'ᯓ 𝙽𝙰𝙼𝙴 ➾  '..Namei..公'    \nᯓ 𝚄𝚂𝙴𝚁 ➾ '..UserNameID..公' .\nᯓ 𝙼𝚂𝙶 ➾  '..msgs..公' .\nᯓ 𝚂𝚃𝙰𝚃𝚄𝚂 ➾ '..msg.TheRank..公' .\nᯓ 𝙸𝙳 ➾ '..msg.sender_user_id_..公' .\nᯓ Ch ⇨ @DannyySource 公 .\nᯓ ᯓ ᯓ',dl_cb,nil)
        else
